...
QUERY_MAX_AGE_TIME = int(os.environ.get("QUERY_MAX_AGE_TIME", "0"))
...
REDASH_PROTECTED_DESTINATION_SYNC_ENABLED = parse_boolean(os.environ.get('REDASH_PROTECTED_DESTINATION_SYNC_ENABLED', 'false'))
ANNOTATE_MYSQL_QUERIES = parse_boolean(os.environ.get("REDASH_ANNOTATE_MYSQL_QUERIES", "false"))
REDASH_WORKER_TIMEOUT = int(os.environ.get('REDASH_WORKER_TIMEOUT', 1200))
